...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
        <a class="navbar-brand" href="../html/index.html">KORA</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href={{route('LastNews')}}>Last News About Kora</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('news')}}">Leagues</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('various')}}">Various Sport
                    </a>
                </li>
                <li class="nav-item">
...
<footer class="py-5 bg-dark">
    <div class="container">
        <p class="m-0 text-center text-white">Copyright &copy; Kora App</p>
    </div>
    <!-- /.container -->
</footer>
