    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <!-- Preview Image -->
                <img class="img-fluid rounded" src="{{asset('website/img/d.jpg')}}" alt="">
                <img class="img-fluid rounded" src="{{asset('website/img/b.jpg')}}" alt="">
                <img class="img-fluid rounded" src="{{asset('website/img/s.jpg')}}" alt="">
